...
export const DEFAULT_BASE_URL = 'https://api.com/';
...
export const POST_UA_HEADER = 'X-Post-Client-User-Agent';

export const DEFAULT_HEADERS = {
  'Accept-Encoding': 'gzip,deflate,sdch,br',
  'Content-Type': 'application/x-www-form-urlencoded',
  'User-Agent': `Post/v2 NodejsClient/${pkg.version}`,
  [POST_UA_HEADER]: JSON.stringify(UA_INFO),
};
